				...
				<div class="loginwarpper">
					<div class="formslogins">
					    <div class="logoindivs">
							...
							<form action="{{action('API\HomeAPIController@doctorlogin')}}" method="post">
                                ...
                                ?></span>
									...
									<div class="center section"><small class="fs13">New to My Doctor UAE?<a  href="{{action('API\HomeAPIController@doctorsignup')}}"> Sign Up</a></small></div>						
								</div>
